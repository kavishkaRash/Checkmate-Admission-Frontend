    ...
    return (
        <div className="bg-[#f8fafc] text-[#0f172a] relative min-h-screen w-full overflow-x-hidden font-sans select-none">
            ...
            <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#f8fafc]">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-[#f8fafc]/50 via-[#f8fafc]/80 to-[#f8fafc] md:bg-gradient-to-r md:from-[#f8fafc] md:via-[#f8fafc]/60 md:to-transparent z-10"></div>
            </div>

            <div className="absolute inset-0 bg-[linear-gradient(rgba(15,23,42,0.005)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.005)_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none z-10"></div>

            <section className="relative z-20 min-h-screen flex items-center px-4 sm:px-6 md:px-16 lg:px-32 pt-28 pb-20">
                ...
                <div className="w-full max-w-2xl relative z-30">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-12 sm:mb-16">
                        <button className="w-full sm:w-auto bg-[#0f172a] text-white text-xs font-bold tracking-widest uppercase px-8 py-4 rounded-xl hover:bg-blue-600 shadow-md transition-all duration-300 transform hover:-translate-y-0.5">
                            Get Free Consultation →
                        </button>
                        <button className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white text-slate-700 hover:text-blue-600 text-xs font-bold px-6 py-4 rounded-xl border border-slate-200 hover:border-blue-300 shadow-sm transition-all duration-300">
                ...
                <div className="hidden xl:block absolute right-24 bottom-32 z-30 bg-white border border-slate-200 rounded-2xl p-6 w-[280px] shadow-lg shadow-slate-100">
